...
public class Aggregation {
    public static void main(String[] args) throws Exception {
        ...
        DataStream < String > data = env.readTextFile("./aggregation/avg1");
        ...
        mapped.keyBy(t -> t.f0).sum(3).writeAsText("./aggregation/out1");

        mapped.keyBy(t -> t.f0).min(3).writeAsText("./aggregation/out2");

        mapped.keyBy(t -> t.f0).minBy(3).writeAsText("./aggregation/out3");

        mapped.keyBy(t -> t.f0).max(3).writeAsText("./aggregation/out4");

        mapped.keyBy(t -> t.f0).maxBy(3).writeAsText("./aggregation/out5");
        // execute program
