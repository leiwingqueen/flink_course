...
public class OuterJoin {
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<Integer, String, String>> joined = mapOp1.fullOuterJoin(mapOp2).where(0).equalTo(0).
                with((JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>) (p1, p2) ->{
            if (p1 == null) {
                return new Tuple3<>(p2.f0, "null", p2.f1);
            }else if (p2 == null) {
                return new Tuple3<>(p1.f0, p1.f1, "null");
            }else{
                return new Tuple3<>(p1.f0, p1.f1, p2.f1);
            }
